...
export function Sidebar({ selectedTopic, onTopicSelect }: SidebarProps) {
  return (
    <aside className="w-full md:w-[20%] fixed md:sticky top-20 left-0 h-auto md:h-[calc(100vh-5rem)] bg-card border-b md:border-b-0 md:border-r border-border/50 overflow-x-auto md:overflow-y-auto z-40">
